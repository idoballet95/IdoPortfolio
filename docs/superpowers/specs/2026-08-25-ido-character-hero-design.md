...
- Use the MacBook to hide the lower face. Show both original-reference eyes fully, plus her eyebrows, forehead, and upper nose looking over the laptop edge. This partial occlusion is intentional and helps preserve identity.
...
- Add subtle sports storytelling through a football, a small tactics board, and a trophy. Place one neat pair of pale blush satin ballet flats beside the football. Do not include football boots.
