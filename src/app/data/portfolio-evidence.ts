...
export const workEvidence: Record<string, WorkEvidence> = {
  "bose-quietcomfort": {
    brief: {
      ko: "노이즈 캔슬링을 기능 설명이 아닌 한 번의 청각적 반전으로 체감시키는 20초 브랜드 필름을 설계했습니다.",
    ...
    creativeDecision: {
      ko: "경기장의 함성을 가장 큰 출발점으로 두고, 헤드폰만 화면에서 채도를 갖게 했습니다. 제품의 색과 정적이 광고의 두 주인공이 되도록 나머지 요소를 절제했습니다.",
    ...
    processAssets: [
      {
        ...
        note: { ko: "제품이 필요한 이유를 첫 프레임에서 만들었습니다.", en: "The first frame establishes why the product is needed." },
      },
      {
        ...
        note: { ko: "큰 움직임과 정적을 충돌시켜 기능을 장면으로 번역했습니다.", en: "Large motion against near-silence turns the feature into a scene." },
      },
      {
        ...
        note: { ko: "한 번의 버튼 동작으로 사운드 전환을 읽히게 했습니다.", en: "A single physical gesture makes the sound transition legible." },
      },
      {
        ...
        note: { ko: "브랜드보다 스타일이 앞서지 않는 가장 조용한 조합을 선택했습니다.", en: "The quietest option was chosen so styling never overtook the brand." },
      },
    ],
    iterations: [
      {
        ...
        decision: {
          ko: "초기 결과보다 캐릭터 방향, 헤드폰 가독성, 교통 장면의 축이 안정된 세 번째 테이크를 선택했습니다. 생성 사운드는 정적을 유지하지 못해 최종 편집에서 직접 다시 설계했습니다.",
  ...
  "step-out-in-color": {
    brief: {
      ko: "다섯 개 풋살화 컬러웨이를 제품 나열이 아니라 하나의 연속 패션 변신으로 보여주는 세로형 광고입니다.",
    ...
    creativeDecision: {
      ko: "흰 스튜디오, 거대한 신발 포털, 회전하는 컬러 스와치라는 세 요소를 고정하고 인물·의상·제품만 색상 순서에 맞춰 전환했습니다.",
    ...
    processAssets: [
      {
        ...
        note: { ko: "색이 바뀌어도 얼굴과 비율은 같은 인물로 유지했습니다.", en: "Face and proportion stay recognisably the same as the colour changes." },
      },
      {
        ...
        note: { ko: "제품 실루엣과 색상 위치를 컷마다 다시 확인했습니다.", en: "Product silhouette and colour placement were checked shot by shot." },
      },
      {
        ...
        note: { ko: "얼굴은 선명하지만 광고 전체를 이끌기에는 표정이 강했습니다.", en: "Clear identity, but the expression competed with the colourway system." },
      },
      {
        ...
        note: { ko: "중립적인 표정과 정면성이 색상 전환에서 가장 안정적으로 유지됐습니다.", en: "A neutral expression and frontal read held most reliably through colour changes." },
      },
    ],
    iterations: [
      {
        ...
        decision: {
          ko: "초기 보드의 단순한 포털 통과를 제품이 화면을 지배하는 탑뷰와 발끝 동작으로 수정했습니다. 컬러 전환의 원인이 더 명확해지고 마지막까지 신발이 기억에 남았습니다.",
  ...
  "yena-hokusai-great-wave": {
    brief: {
      ko: "호쿠사이의 파도가 액자 밖으로 새어 나와 미술관을 침수시키는 20초 재난 코미디를 만들었습니다.",
      en: "A 20-second disaster comedy in which Hokusai's wave leaks out of its frame and floods the museum.",
    },
    creativeDecision: {
      ko: "파도, 수위, 인물 반응과 카메라를 분리해 Blender 움직임 레퍼런스로 먼저 검증했습니다. 물리 시뮬레이션을 복제하는 대신 원인과 결과가 읽히는 시간 순서를 생성 프롬프트에 옮겼습니다.",
    ...
    processAssets: [
      {
        ...
        note: { ko: "움직임과 카메라를 분리하고 수위 상승과 반응의 순서를 먼저 고정했습니다.", en: "Motion and camera are separated before locking the order of rising water and reactions." },
      },
      {
        ...
        note: { ko: "본편과 같은 인물·장소·색감을 유지하는 이미지만 남겼습니다.", en: "Only images that held the same character, place and palette as the film remained." },
      },
      {
        ...
        note: { ko: "장면 전환에서 자막이 한 프레임씩 남거나 잘리지 않는지 확인했습니다.", en: "Boundary frames were checked for lingering or clipped subtitle cards." },
      },
    ],
    iterations: [
      {
        ...
        decision: {
          ko: "선명도만 올리고 인물 피부와 물결의 질감이 인공적으로 변하지 않는 설정을 선택했습니다. 최종본은 더 큰 해상도보다 원본의 자연스러움을 우선해 검수했습니다.",
  ...
  "world-cup-product-collection": {
    brief: {
      ko: "축구화, 물병, 헤어밴드 세 제품을 하나의 월드컵 컬렉션처럼 보이게 하는 41초 제품 필름입니다.",
      en: "A 41-second product film presenting boots, bottle and headband as one World Cup collection.",
    },
    creativeDecision: {
      ko: "서로 다른 Kling·Hailuo 생성 결과를 흰 프로토타입 무대, 모노크롬 재질과 정밀한 손동작이라는 공통 규칙으로 묶었습니다.",
    ...
    processAssets: [
      {
        ...
        note: { ko: "세 제품의 실루엣과 높낮이를 먼저 하나의 컬렉션 문법으로 맞췄습니다.", en: "Silhouette and elevation establish one collection language before colour arrives." },
      },
      {
        ...
        note: { ko: "Kling의 손동작은 작고 정확하게 제한해 소재감과 금색 포인트에 시선을 모았습니다.", en: "Kling's hand motion stays small and precise so texture and the gold accent remain the focus." },
      },
      {
        ...
        note: { ko: "인물이 제품을 가리지 않도록 손의 위치와 프레이밍을 단순하게 유지했습니다.", en: "Hand placement and framing stay simple so the interaction never hides the product." },
      },
      {
        ...
        note: { ko: "화이트 베이스, 레드 패턴과 금색 포인트를 반복해 서로 다른 생성 컷을 한 제품군으로 묶었습니다.", en: "White, red pattern and gold accents repeat to unify separately generated products." },
      },
    ],
  },
};
...
export const editorialCases: EditorialCase[] = [
  {
    ...
    summary: {
      ko: "맛집을 오래 다녀본 언니가 친구에게 사진을 보여주듯 쓰는 목소리를 실제 샘플에서 추출해 재사용 가능한 작성 기준으로 만들었습니다.",
    ...
    steps: [
      { title: { ko: "샘플에서 찾기", en: "Read the samples" }, body: { ko: "반복되는 문장 길이, 판단 방식, 시작과 끝, 쓰지 않는 표현까지 기록했습니다.", en: "Sentence length, judgement patterns, openings, closings and consistently absent language were recorded." } },
      { title: { ko: "한 문장으로 정의", en: "Name the voice" }, body: { ko: "가볍고 친근하지만 식감·간·온도·가격을 구체적으로 짚는 사람으로 화자를 고정했습니다.", en: "The narrator is warm and casual, but precise about texture, seasoning, temperature and price." } },
      { title: { ko: "작성 규칙으로 변환", en: "Turn it into rules" }, body: { ko: "리듬, 1인칭, 메뉴 블록, 솔직한 판단과 금지 문구를 실제 작성 지침으로 바꿨습니다.", en: "Rhythm, first-person use, menu blocks, honest judgement and banned phrasing became practical instructions." } },
      { title: { ko: "사람 말투 QA", en: "Human-voice QA" }, body: { ko: "카톡 테스트, 식탁 장면 테스트, 다른 식당에도 붙는 문장인지 확인한 뒤 통과시킵니다.", en: "Every draft passes conversational, table-scene and specificity checks before approval." } },
    ],
    ...
    decision: { ko: "막연한 칭찬을 지우고 실제 맛, 장면과 다음 선택이 남는 문장으로 바꿨습니다.", en: "Generic praise was replaced with taste, scene and a clear next choice." },
  },
  {
    ...
    summary: {
      ko: "최신 정보 조사부터 보이스 초안, 자연스러운 문장 수정, 모바일 줄바꿈, 이미지 순서와 최종 QA까지 한 콘텐츠 패키지로 제작합니다.",
    ...
    steps: [
      { title: { ko: "Research", en: "Research" }, body: { ko: "영업시간·가격·주차는 현재 출처로 검증하고 개인 경험과 공개 정보를 구분합니다.", en: "Hours, price and parking are verified with current sources and kept separate from personal experience." } },
      { title: { ko: "Voice draft", en: "Voice draft" }, body: { ko: "보이스 프로필을 적용해 사진마다 첫인상, 맛, 식감과 재주문 판단을 씁니다.", en: "The voice profile guides first impression, taste, texture and reorder judgement for each image." } },
      { title: { ko: "Humanize", en: "Humanise" }, body: { ko: "보고서형 결론, 반복 어미와 빈 전환 문구를 찾아 다시 씁니다.", en: "Report-like conclusions, repeated endings and empty transitions are identified and rewritten." } },
      { title: { ko: "Mobile format", en: "Mobile format" }, body: { ko: "의미 단위로 줄을 나누되 메뉴명, 숫자와 조사를 부자연스럽게 끊지 않습니다.", en: "Lines break by meaning without splitting menu names, quantities or grammatical units." } },
      { title: { ko: "Image plan", en: "Image plan" }, body: { ko: "대표 이미지, 지도, 메뉴판과 각 메뉴 사진의 순서를 글 구조와 맞춥니다.", en: "Cover, map, menu and food images are sequenced to match the article structure." } },
      { title: { ko: "Final QA", en: "Final QA" }, body: { ko: "사실, 사진 매칭, 글자 수, 모바일 가독성과 임시저장 결과를 확인합니다.", en: "Facts, image matching, length, mobile readability and saved-draft output are checked." } },
    ],
    ...
    decision: { ko: "검색용 정보와 실제 식탁의 판단을 한 문단에 섞지 않고, 사진에서 확인되는 근거를 중심으로 수정했습니다.", en: "Search information and table-side judgement were separated, then the paragraph was rebuilt around evidence visible in the photo." },
    images: [
